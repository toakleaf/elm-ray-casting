	...
	return _Utils_Tuple2(
		{
			...
			gridMargin: {bottom: 80, left: 0, right: 0, top: 20},
			screen: elm$core$Maybe$Nothing,
			x: 0,
			y: 0
		},
		A2(
...
var author$project$Main$view = function (_n0) {
	var screen = _n0.screen;
	if (screen.$ === 'Just') {
		var dimensions = screen.a;
		return A2(
			elm$html$Html$div,
			_List_fromArray(
				[
